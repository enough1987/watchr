...
ActiveRecord::Schema.define(version: 20160826130639) do
  ...
  create_table "msends", force: :cascade do |t|
  ...
  create_table "seller_images", force: :cascade do |t|
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.string   "upload_session",          limit: 255
  ...
  create_table "sellers", force: :cascade do |t|
    ...
    t.string   "session_upload", limit: 255
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end

  create_table "sendmessages", force: :cascade do |t|
    t.string   "name",       limit: 255
    t.string   "last_name",  limit: 255
    t.text     "message",    limit: 65535
    t.string   "phone",      limit: 255
  ...
  create_table "spree_currency_converters", force: :cascade do |t|
    ...
    t.float    "nominal",     limit: 24, default: 1.0, null: false
  ...
  create_table "spree_msends", force: :cascade do |t|
    t.string   "email",      limit: 255
    t.string   "name",       limit: 255
    t.string   "last_name",  limit: 255
    t.text     "message",    limit: 65535
  ...
  create_table "spree_product_imports", force: :cascade do |t|
    t.string   "variants_csv_file_name",    limit: 255
    t.string   "variants_csv_content_type", limit: 255
    t.integer  "variants_csv_file_size",    limit: 4
    t.datetime "variants_csv_updated_at"
    t.string   "products_csv_file_name",    limit: 255
    t.string   "products_csv_content_type", limit: 255
    t.integer  "products_csv_file_size",    limit: 4
    t.datetime "products_csv_updated_at"
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
  end
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.string   "city",                   limit: 255
    t.string   "phone",                  limit: 255
    t.boolean  "mailchimp_opt_in",                   default: false
    t.string   "full_adress",            limit: 255
  end
  ...
  create_table "watch_services", force: :cascade do |t|
    t.string   "brand",      limit: 255
    t.string   "email",      limit: 255
    t.string   "model",      limit: 255
    t.string   "name",       limit: 255
    t.string   "phone",      limit: 255
    t.string   "polishing",  limit: 255
    t.string   "reference",  limit: 255
    t.string   "repair",     limit: 255
    t.string   "revision",   limit: 255
    t.string   "wristband",  limit: 255
    t.string   "servicing",  limit: 255
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
  end
